...
import {deleteAll,setShowPlayList,deleteSongFromPlayList} from '../../redux/actions'
...
class PlayList extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={`play-list-model ${!this.props.showPlayList?'hidden-play-list-model':''}`} ref="scroll">
                ...
                <div className="play-list">
                    ...
                    <div className="list-box" onTouchMove={this.touchMove}>
                        {list.length === 0?<div className="no-song">{this.state.noDataMsg}</div>:list.map((item,index)=>{
                                return <div  className="list-item" key={'play-item' + index}>
